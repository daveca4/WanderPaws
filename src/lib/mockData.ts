...
export const mockDogs: Dog[] = [
  ...
  },
  {
    ...
    specialNeeds: [],
    ownerId: 'o2',
    imageUrl: 'https://images.unsplash.com/photo-1579213838942-c9c62493c5e0?q=80&w=500',
    walkingPreferences: {
      frequency: 5,
      duration: 60,
  ...
  },
  {
    ...
    age: 2,
    size: 'small',
    temperament: ['energetic', 'affectionate', 'curious'],
    specialNeeds: [],
    ownerId: 'o3',
    imageUrl: 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?q=80&w=500',
    walkingPreferences: {
      frequency: 4,
      duration: 45,
      preferredTimes: ['afternoon'],
